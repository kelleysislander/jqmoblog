...
set :application, 'jqmoblog'
set :app_uri,   'victoria.jqmoblog.com'
set :deploy_to, "/var/www/vhosts/#{app_uri}"
set :gem_home, '/home/deploy/.rvm/gems/ruby-1.9.2-p290@jqmoblog'
...
Global setup:
 ...
 Set up git
  git config --global user.name "Bill Kiskin"
  git config --global user.email bill@semaphoremobile.com
...
Next steps:
  ...
  git remote add origin git@github.com:kelleysislander/jqmoblog.git
